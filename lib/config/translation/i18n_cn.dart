...
final Map<String, String> _cn_ui = {
  ...
  I18n.log_font_system_default: '系统默认',
  ...
  I18n.setting_save_failed: '设置保存失败',
  I18n.save: '保存',
  I18n.none: '无',
  I18n.deployEditHint: '在此编辑 deploy.yaml...',
  // 脚本启停中间态与失败原因
  I18n.script_starting: '正在启动...',
  I18n.script_stopping: '正在停止...',
  I18n.script_start_failed: '脚本启动失败',
  I18n.script_stop_failed: '脚本停止失败',
  I18n.script_action_not_found: '配置不存在',
  I18n.script_action_conflict: '配置正在被修改，请稍后重试',
  I18n.script_action_lock_timeout: '配置被占用，请稍后重试',
  I18n.script_action_server_error: '脚本启动失败，请查看服务端日志',
  I18n.config_processing: '正在处理...',
